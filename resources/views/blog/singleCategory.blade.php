...
@section('breadcrumbs')
    <div class="breadcrumbs"><span class="crumbs" xmlns:v="https://rdf.data-vocabulary.org/#">
                                    <span typeof="v:Breadcrumb"> <a rel="v:url" property="v:title" href="/">
                                        ...
                                        <span rel="v:child" typeof="v:Breadcrumb" href="/blog/">
                                            <span class="crumbs-span"> / </span><a href="/blog/">Blog</a></span>
                                        <span rel="v:child" typeof="v:Breadcrumb">
                                            <span class="crumbs-span"> / </span><span class="current"><a class="current">{{request()->category->name}}</a></span>
                                            </span>
                                        </span>
...
@section('blogPosts')
        ...
        <article id="post-{{$post->id}}" class="article-post article-post-only">
            <div class="single-inner-content">
                <header class="article-header">
                    ...
                    <h2 class="post-title"><a class="post-title" href="/blog/{{$post->slug}}" rel="bookmark">{{$post->title}}</a></h2>
                    <a class="post-author" rel="author" href="/profil/{{getUserData($post->owner)->first()->username}}">{{getUserData($post->owner)->first()->name}}</a>
    ...
    @if($posts->count() <1)
        <div class="col-12">
        <a> Henüz bu kategoride yazı paylaşılmamış.</a>
        </div>
    @endif
@endsection
